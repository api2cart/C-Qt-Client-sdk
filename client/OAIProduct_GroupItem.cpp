...
double OAIProduct_GroupItem::getPrice() const {
    return m_price;
}
void OAIProduct_GroupItem::setPrice(const double &price) {
    m_price = price;
    m_price_isSet = true;
}

bool OAIProduct_GroupItem::is_price_Set() const{
    return m_price_isSet;
}

bool OAIProduct_GroupItem::is_price_Valid() const{
