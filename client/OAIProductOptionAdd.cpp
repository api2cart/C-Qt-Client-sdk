...
QString OAIProductOptionAdd::getIdempotencyKey() const {
    return m_idempotency_key;
}
void OAIProductOptionAdd::setIdempotencyKey(const QString &idempotency_key) {
    m_idempotency_key = idempotency_key;
    m_idempotency_key_isSet = true;
}

bool OAIProductOptionAdd::is_idempotency_key_Set() const{
    return m_idempotency_key_isSet;
}

bool OAIProductOptionAdd::is_idempotency_key_Valid() const{
