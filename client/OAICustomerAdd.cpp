...
void OAICustomerAdd::setGroupIds(const QString &group_ids) {
    m_group_ids = group_ids;
    m_group_ids_isSet = true;
}

bool OAICustomerAdd::is_group_ids_Set() const{
    return m_group_ids_isSet;
}

bool OAICustomerAdd::is_group_ids_Valid() const{
...
void OAICustomerAdd::setConsents(const QList<OAICustomerAdd_consents_inner> &consents) {
    m_consents = consents;
    m_consents_isSet = true;
}

bool OAICustomerAdd::is_consents_Set() const{
    return m_consents_isSet;
}

bool OAICustomerAdd::is_consents_Valid() const{
...
QString OAICustomerAdd::getNote() const {
    return m_note;
}
void OAICustomerAdd::setNote(const QString &note) {
    m_note = note;
    m_note_isSet = true;
}

bool OAICustomerAdd::is_note_Set() const{
    return m_note_isSet;
}

bool OAICustomerAdd::is_note_Valid() const{
    return m_note_isValid;
}

QString OAICustomerAdd::getCountry() const {
    return m_country;
}
void OAICustomerAdd::setCountry(const QString &country) {
    m_country = country;
    m_country_isSet = true;
}

bool OAICustomerAdd::is_country_Set() const{
    return m_country_isSet;
}

bool OAICustomerAdd::is_country_Valid() const{
    return m_country_isValid;
}

QString OAICustomerAdd::getCurrencyId() const {
    return m_currency_id;
}
void OAICustomerAdd::setCurrencyId(const QString &currency_id) {
    m_currency_id = currency_id;
    m_currency_id_isSet = true;
}

bool OAICustomerAdd::is_currency_id_Set() const{
    return m_currency_id_isSet;
}

bool OAICustomerAdd::is_currency_id_Valid() const{
    return m_currency_id_isValid;
}

bool OAICustomerAdd::isIsTaxExempt() const {
    return m_is_tax_exempt;
}
void OAICustomerAdd::setIsTaxExempt(const bool &is_tax_exempt) {
    m_is_tax_exempt = is_tax_exempt;
    m_is_tax_exempt_isSet = true;
}

bool OAICustomerAdd::is_is_tax_exempt_Set() const{
    return m_is_tax_exempt_isSet;
}

bool OAICustomerAdd::is_is_tax_exempt_Valid() const{
    return m_is_tax_exempt_isValid;
}

QString OAICustomerAdd::getVendorId() const {
    return m_vendor_id;
}
void OAICustomerAdd::setVendorId(const QString &vendor_id) {
    m_vendor_id = vendor_id;
    m_vendor_id_isSet = true;
}

bool OAICustomerAdd::is_vendor_id_Set() const{
    return m_vendor_id_isSet;
}

bool OAICustomerAdd::is_vendor_id_Valid() const{
...
QString OAICustomerAdd::getIdempotencyKey() const {
    return m_idempotency_key;
}
void OAICustomerAdd::setIdempotencyKey(const QString &idempotency_key) {
    m_idempotency_key = idempotency_key;
    m_idempotency_key_isSet = true;
}

bool OAICustomerAdd::is_idempotency_key_Set() const{
    return m_idempotency_key_isSet;
}

bool OAICustomerAdd::is_idempotency_key_Valid() const{
