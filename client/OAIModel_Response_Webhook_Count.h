...
/*
 * OAIModel_Response_Webhook_Count.h
 *
 * 
 */

#ifndef OAIModel_Response_Webhook_Count_H
#define OAIModel_Response_Webhook_Count_H
...
namespace OpenAPI {
class OAIResponse_Webhook_Count_Result;

class OAIModel_Response_Webhook_Count : public OAIObject {
public:
    OAIModel_Response_Webhook_Count();
    OAIModel_Response_Webhook_Count(QString json);
    ~OAIModel_Response_Webhook_Count() override;
    ...
    OAIResponse_Webhook_Count_Result getResult() const;
    void setResult(const OAIResponse_Webhook_Count_Result &result);
...
private:
    ...
    OAIResponse_Webhook_Count_Result m_result;
    bool m_result_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIModel_Response_Webhook_Count)

#endif // OAIModel_Response_Webhook_Count_H
