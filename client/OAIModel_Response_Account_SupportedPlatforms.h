...
/*
 * OAIModel_Response_Account_SupportedPlatforms.h
 *
 * 
 */

#ifndef OAIModel_Response_Account_SupportedPlatforms_H
#define OAIModel_Response_Account_SupportedPlatforms_H
...
namespace OpenAPI {
class OAIResponse_Account_SupportedPlatforms_Result;

class OAIModel_Response_Account_SupportedPlatforms : public OAIObject {
public:
    OAIModel_Response_Account_SupportedPlatforms();
    OAIModel_Response_Account_SupportedPlatforms(QString json);
    ~OAIModel_Response_Account_SupportedPlatforms() override;
    ...
    OAIResponse_Account_SupportedPlatforms_Result getResult() const;
    void setResult(const OAIResponse_Account_SupportedPlatforms_Result &result);
...
private:
    ...
    OAIResponse_Account_SupportedPlatforms_Result m_result;
    bool m_result_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIModel_Response_Account_SupportedPlatforms)

#endif // OAIModel_Response_Account_SupportedPlatforms_H
