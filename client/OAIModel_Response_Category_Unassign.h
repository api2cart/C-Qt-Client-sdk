...
/*
 * OAIModel_Response_Category_Unassign.h
 *
 * 
 */

#ifndef OAIModel_Response_Category_Unassign_H
#define OAIModel_Response_Category_Unassign_H
...
namespace OpenAPI {
class OAIResponse_Category_Unassign_Result;

class OAIModel_Response_Category_Unassign : public OAIObject {
public:
    OAIModel_Response_Category_Unassign();
    OAIModel_Response_Category_Unassign(QString json);
    ~OAIModel_Response_Category_Unassign() override;
    ...
    OAIResponse_Category_Unassign_Result getResult() const;
    void setResult(const OAIResponse_Category_Unassign_Result &result);
...
private:
    ...
    OAIResponse_Category_Unassign_Result m_result;
    bool m_result_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIModel_Response_Category_Unassign)

#endif // OAIModel_Response_Category_Unassign_H
