...
/*
 * OAIAnalytics_Metric.h
 *
 * 
 */

#ifndef OAIAnalytics_Metric_H
#define OAIAnalytics_Metric_H
...
class OAIAnalytics_Metric : public OAIObject {
public:
    OAIAnalytics_Metric();
    OAIAnalytics_Metric(QString json);
    ~OAIAnalytics_Metric() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAnalytics_Metric)

#endif // OAIAnalytics_Metric_H
