...
#ifndef OAIReturn_Action_H
#define OAIReturn_Action_H
...
class OAIReturn_Action : public OAIObject {
public:
    OAIReturn_Action();
    OAIReturn_Action(QString json);
    ~OAIReturn_Action() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIReturn_Action)

#endif // OAIReturn_Action_H
