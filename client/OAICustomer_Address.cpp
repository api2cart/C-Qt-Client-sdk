...
QString OAICustomer_Address::getAlias() const {
    return m_alias;
}
void OAICustomer_Address::setAlias(const QString &alias) {
    m_alias = alias;
    m_alias_isSet = true;
}

bool OAICustomer_Address::is_alias_Set() const{
    return m_alias_isSet;
}

bool OAICustomer_Address::is_alias_Valid() const{
