...
/*
 * OAIModel_Response_Attribute_Type_List.h
 *
 * 
 */

#ifndef OAIModel_Response_Attribute_Type_List_H
#define OAIModel_Response_Attribute_Type_List_H
...
namespace OpenAPI {
class OAIResponse_Attribute_Type_List_Result;

class OAIModel_Response_Attribute_Type_List : public OAIObject {
public:
    OAIModel_Response_Attribute_Type_List();
    OAIModel_Response_Attribute_Type_List(QString json);
    ~OAIModel_Response_Attribute_Type_List() override;
    ...
    OAIResponse_Attribute_Type_List_Result getResult() const;
    void setResult(const OAIResponse_Attribute_Type_List_Result &result);
...
private:
    ...
    OAIResponse_Attribute_Type_List_Result m_result;
    bool m_result_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIModel_Response_Attribute_Type_List)

#endif // OAIModel_Response_Attribute_Type_List_H
