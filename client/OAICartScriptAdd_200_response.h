...
#ifndef OAICartScriptAdd_200_response_H
#define OAICartScriptAdd_200_response_H
...
namespace OpenAPI {
class OAICartScriptAdd_200_response_result;

class OAICartScriptAdd_200_response : public OAIObject {
public:
    OAICartScriptAdd_200_response();
    OAICartScriptAdd_200_response(QString json);
    ~OAICartScriptAdd_200_response() override;
    ...
    OAICartScriptAdd_200_response_result getResult() const;
    void setResult(const OAICartScriptAdd_200_response_result &result);
...
private:
    ...
    OAICartScriptAdd_200_response_result m_result;
    bool m_result_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAICartScriptAdd_200_response)

#endif // OAICartScriptAdd_200_response_H
