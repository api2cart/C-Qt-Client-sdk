...
#ifndef OAIProductUpdateBatch_payload_inner_H
#define OAIProductUpdateBatch_payload_inner_H
...
class OAIProductUpdateBatch_payload_inner_images_inner;

class OAIProductUpdateBatch_payload_inner : public OAIObject {
public:
    OAIProductUpdateBatch_payload_inner();
    OAIProductUpdateBatch_payload_inner(QString json);
    ~OAIProductUpdateBatch_payload_inner() override;
    ...
    QList<OAIProductUpdateBatch_payload_inner_images_inner> getImages() const;
    void setImages(const QList<OAIProductUpdateBatch_payload_inner_images_inner> &images);
...
private:
    ...
    QList<OAIProductUpdateBatch_payload_inner_images_inner> m_images;
    bool m_images_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIProductUpdateBatch_payload_inner)

#endif // OAIProductUpdateBatch_payload_inner_H
