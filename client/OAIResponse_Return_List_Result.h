...
#ifndef OAIResponse_Return_List_Result_H
#define OAIResponse_Return_List_Result_H
...
class OAIResponse_Return_List_Result : public OAIObject {
public:
    OAIResponse_Return_List_Result();
    OAIResponse_Return_List_Result(QString json);
    ~OAIResponse_Return_List_Result() override;
    ...
    QList<OAIReturn> getReturns() const;
    void setReturns(const QList<OAIReturn> &returns);
...
Q_DECLARE_METATYPE(OpenAPI::OAIResponse_Return_List_Result)

#endif // OAIResponse_Return_List_Result_H
