...
#ifndef OAIProductUpdateBatch_H
#define OAIProductUpdateBatch_H
...
namespace OpenAPI {
class OAIProductUpdateBatch_payload_inner;

class OAIProductUpdateBatch : public OAIObject {
public:
    OAIProductUpdateBatch();
    OAIProductUpdateBatch(QString json);
    ~OAIProductUpdateBatch() override;
    ...
    QList<OAIProductUpdateBatch_payload_inner> getPayload() const;
    void setPayload(const QList<OAIProductUpdateBatch_payload_inner> &payload);
...
private:
    ...
    QList<OAIProductUpdateBatch_payload_inner> m_payload;
...
Q_DECLARE_METATYPE(OpenAPI::OAIProductUpdateBatch)

#endif // OAIProductUpdateBatch_H
