...
/*
 * OAIModel_Response_Cart_Methods.h
 *
 * 
 */

#ifndef OAIModel_Response_Cart_Methods_H
#define OAIModel_Response_Cart_Methods_H
...
namespace OpenAPI {
class OAIResponse_Cart_Methods_Result;

class OAIModel_Response_Cart_Methods : public OAIObject {
public:
    OAIModel_Response_Cart_Methods();
    OAIModel_Response_Cart_Methods(QString json);
    ~OAIModel_Response_Cart_Methods() override;
    ...
    OAIResponse_Cart_Methods_Result getResult() const;
    void setResult(const OAIResponse_Cart_Methods_Result &result);
...
private:
    ...
    OAIResponse_Cart_Methods_Result m_result;
    bool m_result_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIModel_Response_Cart_Methods)

#endif // OAIModel_Response_Cart_Methods_H
