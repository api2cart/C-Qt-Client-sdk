...
public:
    ...
    * @param[in]  store_id QString [optional]
    */
    virtual void attributeValueDelete(const QString &id, const QString &attribute_id, const ::OpenAPI::OptionalParam<QString> &store_id = ::OpenAPI::OptionalParam<QString>());
...
private:
    ...
    void attributeValueAddCallback(OAIHttpRequestWorker *worker);
    void attributeValueDeleteCallback(OAIHttpRequestWorker *worker);
    void attributeValueUpdateCallback(OAIHttpRequestWorker *worker);
...
Q_SIGNALS:
    ...
    void attributeValueAddSignal(OAIAttributeAdd_200_response summary);
    void attributeValueDeleteSignal(OAIAttributeValueDelete_200_response summary);
    void attributeValueUpdateSignal(OAIAttributeUpdate_200_response summary);
    ...
    void attributeValueAddSignalFull(OAIHttpRequestWorker *worker, OAIAttributeAdd_200_response summary);
    void attributeValueDeleteSignalFull(OAIHttpRequestWorker *worker, OAIAttributeValueDelete_200_response summary);
    void attributeValueUpdateSignalFull(OAIHttpRequestWorker *worker, OAIAttributeUpdate_200_response summary);
    ...
    void attributeGroupListSignalE(OAIModel_Response_Attribute_Group_List summary, QNetworkReply::NetworkError error_type, QString error_str);
    void attributeGroupListSignalError(OAIModel_Response_Attribute_Group_List summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use attributeValueAddSignalError() instead")
    void attributeValueAddSignalE(OAIAttributeAdd_200_response summary, QNetworkReply::NetworkError error_type, QString error_str);
    void attributeValueAddSignalError(OAIAttributeAdd_200_response summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use attributeValueDeleteSignalError() instead")
    void attributeValueDeleteSignalE(OAIAttributeValueDelete_200_response summary, QNetworkReply::NetworkError error_type, QString error_str);
    void attributeValueDeleteSignalError(OAIAttributeValueDelete_200_response summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use attributeValueUpdateSignalError() instead")
    void attributeValueUpdateSignalE(OAIAttributeUpdate_200_response summary, QNetworkReply::NetworkError error_type, QString error_str);
    void attributeValueUpdateSignalError(OAIAttributeUpdate_200_response summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use attributeValueAddSignalErrorFull() instead")
    void attributeValueAddSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void attributeValueAddSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use attributeValueDeleteSignalErrorFull() instead")
    void attributeValueDeleteSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void attributeValueDeleteSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use attributeValueUpdateSignalErrorFull() instead")
    void attributeValueUpdateSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void attributeValueUpdateSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
