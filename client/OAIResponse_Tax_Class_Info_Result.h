...
#ifndef OAIResponse_Tax_Class_Info_Result_H
#define OAIResponse_Tax_Class_Info_Result_H
...
class OAIResponse_Tax_Class_Info_Result : public OAIObject {
public:
    OAIResponse_Tax_Class_Info_Result();
    OAIResponse_Tax_Class_Info_Result(QString json);
    ~OAIResponse_Tax_Class_Info_Result() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIResponse_Tax_Class_Info_Result)

#endif // OAIResponse_Tax_Class_Info_Result_H
