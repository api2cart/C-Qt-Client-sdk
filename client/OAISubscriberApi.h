...
Q_SIGNALS:
    ...
    void subscriberListSignal(OAIModel_Response_Subscriber_List summary);


    void subscriberListSignalFull(OAIHttpRequestWorker *worker, OAIModel_Response_Subscriber_List summary);

    Q_DECL_DEPRECATED_X("Use subscriberListSignalError() instead")
    void subscriberListSignalE(OAIModel_Response_Subscriber_List summary, QNetworkReply::NetworkError error_type, QString error_str);
    void subscriberListSignalError(OAIModel_Response_Subscriber_List summary, QNetworkReply::NetworkError error_type, const QString &error_str);
