...
OAIA2CDateTime OAIShipment::getDeliveredAt() const {
    return m_delivered_at;
}
void OAIShipment::setDeliveredAt(const OAIA2CDateTime &delivered_at) {
    m_delivered_at = delivered_at;
    m_delivered_at_isSet = true;
}

bool OAIShipment::is_delivered_at_Set() const{
    return m_delivered_at_isSet;
}

bool OAIShipment::is_delivered_at_Valid() const{
