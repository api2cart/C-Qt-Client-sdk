...
#ifndef OAICustomerInfo_200_response_H
#define OAICustomerInfo_200_response_H
...
class OAICustomerInfo_200_response : public OAIObject {
public:
    OAICustomerInfo_200_response();
    OAICustomerInfo_200_response(QString json);
    ~OAICustomerInfo_200_response() override;
    ...
    OAICustomer getResult() const;
    void setResult(const OAICustomer &result);
...
Q_DECLARE_METATYPE(OpenAPI::OAICustomerInfo_200_response)

#endif // OAICustomerInfo_200_response_H
