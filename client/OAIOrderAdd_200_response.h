...
#ifndef OAIOrderAdd_200_response_H
#define OAIOrderAdd_200_response_H
...
namespace OpenAPI {
class OAIOrderAdd_200_response_result;

class OAIOrderAdd_200_response : public OAIObject {
public:
    OAIOrderAdd_200_response();
    OAIOrderAdd_200_response(QString json);
    ~OAIOrderAdd_200_response() override;
    ...
    OAIOrderAdd_200_response_result getResult() const;
    void setResult(const OAIOrderAdd_200_response_result &result);
...
private:
    ...
    OAIOrderAdd_200_response_result m_result;
    bool m_result_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIOrderAdd_200_response)

#endif // OAIOrderAdd_200_response_H
