...
#ifndef OAIOrderRefundAdd_200_response_H
#define OAIOrderRefundAdd_200_response_H
...
namespace OpenAPI {
class OAIOrderRefundAdd_200_response_result;

class OAIOrderRefundAdd_200_response : public OAIObject {
public:
    OAIOrderRefundAdd_200_response();
    OAIOrderRefundAdd_200_response(QString json);
    ~OAIOrderRefundAdd_200_response() override;
    ...
    OAIOrderRefundAdd_200_response_result getResult() const;
    void setResult(const OAIOrderRefundAdd_200_response_result &result);
...
private:
    ...
    OAIOrderRefundAdd_200_response_result m_result;
    bool m_result_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIOrderRefundAdd_200_response)

#endif // OAIOrderRefundAdd_200_response_H
