...
#ifndef OAIResponse_Product_ChildItem_List_Result_H
#define OAIResponse_Product_ChildItem_List_Result_H
...
class OAIResponse_Product_ChildItem_List_Result : public OAIObject {
public:
    OAIResponse_Product_ChildItem_List_Result();
    OAIResponse_Product_ChildItem_List_Result(QString json);
    ~OAIResponse_Product_ChildItem_List_Result() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIResponse_Product_ChildItem_List_Result)

#endif // OAIResponse_Product_ChildItem_List_Result_H
