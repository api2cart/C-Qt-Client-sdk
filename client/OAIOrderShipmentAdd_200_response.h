...
#ifndef OAIOrderShipmentAdd_200_response_H
#define OAIOrderShipmentAdd_200_response_H
...
namespace OpenAPI {
class OAIOrderShipmentAdd_200_response_result;

class OAIOrderShipmentAdd_200_response : public OAIObject {
public:
    OAIOrderShipmentAdd_200_response();
    OAIOrderShipmentAdd_200_response(QString json);
    ~OAIOrderShipmentAdd_200_response() override;
    ...
    OAIOrderShipmentAdd_200_response_result getResult() const;
    void setResult(const OAIOrderShipmentAdd_200_response_result &result);
...
private:
    ...
    OAIOrderShipmentAdd_200_response_result m_result;
    bool m_result_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIOrderShipmentAdd_200_response)

#endif // OAIOrderShipmentAdd_200_response_H
