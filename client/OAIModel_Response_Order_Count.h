...
/*
 * OAIModel_Response_Order_Count.h
 *
 * 
 */

#ifndef OAIModel_Response_Order_Count_H
#define OAIModel_Response_Order_Count_H
...
namespace OpenAPI {
class OAIResponse_Order_Count_Result;

class OAIModel_Response_Order_Count : public OAIObject {
public:
    OAIModel_Response_Order_Count();
    OAIModel_Response_Order_Count(QString json);
    ~OAIModel_Response_Order_Count() override;
    ...
    OAIResponse_Order_Count_Result getResult() const;
    void setResult(const OAIResponse_Order_Count_Result &result);
...
private:
    ...
    OAIResponse_Order_Count_Result m_result;
    bool m_result_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIModel_Response_Order_Count)

#endif // OAIModel_Response_Order_Count_H
