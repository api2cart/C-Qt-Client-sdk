...
#ifndef OAIReturnReasonList_200_response_H
#define OAIReturnReasonList_200_response_H
...
namespace OpenAPI {
class OAIReturnReasonList_200_response_result;

class OAIReturnReasonList_200_response : public OAIObject {
public:
    OAIReturnReasonList_200_response();
    OAIReturnReasonList_200_response(QString json);
    ~OAIReturnReasonList_200_response() override;
    ...
    OAIReturnReasonList_200_response_result getResult() const;
    void setResult(const OAIReturnReasonList_200_response_result &result);
...
private:
    ...
    OAIReturnReasonList_200_response_result m_result;
    bool m_result_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIReturnReasonList_200_response)

#endif // OAIReturnReasonList_200_response_H
