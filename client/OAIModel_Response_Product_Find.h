...
/*
 * OAIModel_Response_Product_Find.h
 *
 * 
 */

#ifndef OAIModel_Response_Product_Find_H
#define OAIModel_Response_Product_Find_H
...
namespace OpenAPI {
class OAIResponse_Product_Find_Result;

class OAIModel_Response_Product_Find : public OAIObject {
public:
    OAIModel_Response_Product_Find();
    OAIModel_Response_Product_Find(QString json);
    ~OAIModel_Response_Product_Find() override;
    ...
    OAIResponse_Product_Find_Result getResult() const;
    void setResult(const OAIResponse_Product_Find_Result &result);
...
private:
    ...
    OAIResponse_Product_Find_Result m_result;
    bool m_result_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIModel_Response_Product_Find)

#endif // OAIModel_Response_Product_Find_H
