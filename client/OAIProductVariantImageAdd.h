...
#ifndef OAIProductVariantImageAdd_H
#define OAIProductVariantImageAdd_H
...
class OAIProductVariantImageAdd : public OAIObject {
public:
    OAIProductVariantImageAdd();
    OAIProductVariantImageAdd(QString json);
    ~OAIProductVariantImageAdd() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIProductVariantImageAdd)

#endif // OAIProductVariantImageAdd_H
