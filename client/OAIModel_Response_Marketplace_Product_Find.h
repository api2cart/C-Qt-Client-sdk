...
#ifndef OAIModel_Response_Marketplace_Product_Find_H
#define OAIModel_Response_Marketplace_Product_Find_H
...
namespace OpenAPI {
class OAIPagination;
class OAIResponse_Marketplace_Product_Find_Result;

class OAIModel_Response_Marketplace_Product_Find : public OAIObject {
public:
    OAIModel_Response_Marketplace_Product_Find();
    OAIModel_Response_Marketplace_Product_Find(QString json);
    ~OAIModel_Response_Marketplace_Product_Find() override;
    ...
    OAIResponse_Marketplace_Product_Find_Result getResult() const;
    void setResult(const OAIResponse_Marketplace_Product_Find_Result &result);
...
private:
    ...
    OAIResponse_Marketplace_Product_Find_Result m_result;
    bool m_result_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIModel_Response_Marketplace_Product_Find)

#endif // OAIModel_Response_Marketplace_Product_Find_H
