...
#ifndef OAIAttributeUpdate_200_response_H
#define OAIAttributeUpdate_200_response_H
...
namespace OpenAPI {
class OAIAttributeUpdate_200_response_result;

class OAIAttributeUpdate_200_response : public OAIObject {
public:
    OAIAttributeUpdate_200_response();
    OAIAttributeUpdate_200_response(QString json);
    ~OAIAttributeUpdate_200_response() override;
    ...
    OAIAttributeUpdate_200_response_result getResult() const;
    void setResult(const OAIAttributeUpdate_200_response_result &result);
...
private:
    ...
    OAIAttributeUpdate_200_response_result m_result;
    bool m_result_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAttributeUpdate_200_response)

#endif // OAIAttributeUpdate_200_response_H
