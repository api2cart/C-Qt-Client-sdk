...
#ifndef OAICategoryAssign_200_response_H
#define OAICategoryAssign_200_response_H
...
class OAICategoryAssign_200_response : public OAIObject {
public:
    OAICategoryAssign_200_response();
    OAICategoryAssign_200_response(QString json);
    ~OAICategoryAssign_200_response() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICategoryAssign_200_response)

#endif // OAICategoryAssign_200_response_H
