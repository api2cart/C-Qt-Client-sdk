...
QList<OAICustomer_Consent> OAICustomer::getConsents() const {
    return m_consents;
}
void OAICustomer::setConsents(const QList<OAICustomer_Consent> &consents) {
    m_consents = consents;
    m_consents_isSet = true;
}

bool OAICustomer::is_consents_Set() const{
    return m_consents_isSet;
}

bool OAICustomer::is_consents_Valid() const{
