...
/*
 * OAIModel_Response_Return_Status_List.h
 *
 * 
 */

#ifndef OAIModel_Response_Return_Status_List_H
#define OAIModel_Response_Return_Status_List_H
...
namespace OpenAPI {
class OAIResponse_Return_Status_List_Result;

class OAIModel_Response_Return_Status_List : public OAIObject {
public:
    OAIModel_Response_Return_Status_List();
    OAIModel_Response_Return_Status_List(QString json);
    ~OAIModel_Response_Return_Status_List() override;
    ...
    OAIResponse_Return_Status_List_Result getResult() const;
    void setResult(const OAIResponse_Return_Status_List_Result &result);
...
private:
    ...
    OAIResponse_Return_Status_List_Result m_result;
    bool m_result_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIModel_Response_Return_Status_List)

#endif // OAIModel_Response_Return_Status_List_H
