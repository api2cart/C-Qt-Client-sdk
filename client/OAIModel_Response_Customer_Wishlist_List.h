...
#ifndef OAIModel_Response_Customer_Wishlist_List_H
#define OAIModel_Response_Customer_Wishlist_List_H
...
class OAIModel_Response_Customer_Wishlist_List : public OAIObject {
public:
    OAIModel_Response_Customer_Wishlist_List();
    OAIModel_Response_Customer_Wishlist_List(QString json);
    ~OAIModel_Response_Customer_Wishlist_List() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIModel_Response_Customer_Wishlist_List)

#endif // OAIModel_Response_Customer_Wishlist_List_H
