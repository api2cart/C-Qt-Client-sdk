...
#ifndef OAIReturnInfo_200_response_H
#define OAIReturnInfo_200_response_H
...
class OAIReturnInfo_200_response : public OAIObject {
public:
    OAIReturnInfo_200_response();
    OAIReturnInfo_200_response(QString json);
    ~OAIReturnInfo_200_response() override;
    ...
    OAIReturn getResult() const;
    void setResult(const OAIReturn &result);
...
Q_DECLARE_METATYPE(OpenAPI::OAIReturnInfo_200_response)

#endif // OAIReturnInfo_200_response_H
