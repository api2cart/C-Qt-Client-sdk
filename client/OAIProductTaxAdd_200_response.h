...
#ifndef OAIProductTaxAdd_200_response_H
#define OAIProductTaxAdd_200_response_H
...
namespace OpenAPI {
class OAIProductTaxAdd_200_response_result;

class OAIProductTaxAdd_200_response : public OAIObject {
public:
    OAIProductTaxAdd_200_response();
    OAIProductTaxAdd_200_response(QString json);
    ~OAIProductTaxAdd_200_response() override;
    ...
    OAIProductTaxAdd_200_response_result getResult() const;
    void setResult(const OAIProductTaxAdd_200_response_result &result);
...
private:
    ...
    OAIProductTaxAdd_200_response_result m_result;
    bool m_result_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIProductTaxAdd_200_response)

#endif // OAIProductTaxAdd_200_response_H
