...
/*
 * OAIModel_Response_Webhook_Events.h
 *
 * 
 */

#ifndef OAIModel_Response_Webhook_Events_H
#define OAIModel_Response_Webhook_Events_H
...
namespace OpenAPI {
class OAIResponse_Webhook_Events_Result;

class OAIModel_Response_Webhook_Events : public OAIObject {
public:
    OAIModel_Response_Webhook_Events();
    OAIModel_Response_Webhook_Events(QString json);
    ~OAIModel_Response_Webhook_Events() override;
    ...
    OAIResponse_Webhook_Events_Result getResult() const;
    void setResult(const OAIResponse_Webhook_Events_Result &result);
...
private:
    ...
    OAIResponse_Webhook_Events_Result m_result;
    bool m_result_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIModel_Response_Webhook_Events)

#endif // OAIModel_Response_Webhook_Events_H
