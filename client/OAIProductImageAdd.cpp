...
void OAIProductImageAdd::fromJsonObject(QJsonObject json) {
    ...
    m_option_value_ids_isValid = ::OpenAPI::fromJsonValue(m_option_value_ids, json[QString("option_value_ids")]);
    m_option_value_ids_isSet = !json[QString("option_value_ids")].isNull() && m_option_value_ids_isValid;
...
QJsonObject OAIProductImageAdd::asJsonObject() const {
    ...
    if (m_option_value_ids_isSet) {
        obj.insert(QString("option_value_ids"), ::OpenAPI::toJsonValue(m_option_value_ids));
    }
    if (m_store_id_isSet) {
...
QString OAIProductImageAdd::getProductVariantId() const {
    return m_product_variant_id;
}
void OAIProductImageAdd::setProductVariantId(const QString &product_variant_id) {
...
QString OAIProductImageAdd::getOptionValueIds() const {
    return m_option_value_ids;
}
void OAIProductImageAdd::setOptionValueIds(const QString &option_value_ids) {
    m_option_value_ids = option_value_ids;
    m_option_value_ids_isSet = true;
}

bool OAIProductImageAdd::is_option_value_ids_Set() const{
    return m_option_value_ids_isSet;
}

bool OAIProductImageAdd::is_option_value_ids_Valid() const{
...
bool OAIProductImageAdd::isUseLatestApiVersion() const {
    return m_use_latest_api_version;
}
void OAIProductImageAdd::setUseLatestApiVersion(const bool &use_latest_api_version) {
    m_use_latest_api_version = use_latest_api_version;
    m_use_latest_api_version_isSet = true;
}

bool OAIProductImageAdd::is_use_latest_api_version_Set() const{
    return m_use_latest_api_version_isSet;
}

bool OAIProductImageAdd::is_use_latest_api_version_Valid() const{
...
bool OAIProductImageAdd::isValid() const {
    ...
    return m_type_isValid && m_image_name_isValid && true;
}
