...
/*
 * OAIModel_Response_Attribute_Count.h
 *
 * 
 */

#ifndef OAIModel_Response_Attribute_Count_H
#define OAIModel_Response_Attribute_Count_H
...
namespace OpenAPI {
class OAIResponse_Attribute_Count_Result;

class OAIModel_Response_Attribute_Count : public OAIObject {
public:
    OAIModel_Response_Attribute_Count();
    OAIModel_Response_Attribute_Count(QString json);
    ~OAIModel_Response_Attribute_Count() override;
    ...
    OAIResponse_Attribute_Count_Result getResult() const;
    void setResult(const OAIResponse_Attribute_Count_Result &result);
...
private:
    ...
    OAIResponse_Attribute_Count_Result m_result;
    bool m_result_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIModel_Response_Attribute_Count)

#endif // OAIModel_Response_Attribute_Count_H
