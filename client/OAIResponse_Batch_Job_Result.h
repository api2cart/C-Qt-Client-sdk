...
#ifndef OAIResponse_Batch_Job_Result_H
#define OAIResponse_Batch_Job_Result_H
...
namespace OpenAPI {
class OAIBatch_Job_Result;

class OAIResponse_Batch_Job_Result : public OAIObject {
public:
    OAIResponse_Batch_Job_Result();
    OAIResponse_Batch_Job_Result(QString json);
    ~OAIResponse_Batch_Job_Result() override;
    ...
    OAIBatch_Job_Result getResult() const;
    void setResult(const OAIBatch_Job_Result &result);
...
Q_DECLARE_METATYPE(OpenAPI::OAIResponse_Batch_Job_Result)

#endif // OAIResponse_Batch_Job_Result_H
