...
/*
 * OAIResponse_Order_Count_Result.h
 *
 * 
 */

#ifndef OAIResponse_Order_Count_Result_H
#define OAIResponse_Order_Count_Result_H
...
class OAIResponse_Order_Count_Result : public OAIObject {
public:
    OAIResponse_Order_Count_Result();
    OAIResponse_Order_Count_Result(QString json);
    ~OAIResponse_Order_Count_Result() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIResponse_Order_Count_Result)

#endif // OAIResponse_Order_Count_Result_H
