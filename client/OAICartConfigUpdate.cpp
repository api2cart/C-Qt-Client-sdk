...
QString OAICartConfigUpdate::getUserAgent() const {
    return m_user_agent;
}
void OAICartConfigUpdate::setUserAgent(const QString &user_agent) {
    m_user_agent = user_agent;
    m_user_agent_isSet = true;
}

bool OAICartConfigUpdate::is_user_agent_Set() const{
    return m_user_agent_isSet;
}

bool OAICartConfigUpdate::is_user_agent_Valid() const{
