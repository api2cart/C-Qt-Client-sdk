...
/*
 * OAIResponse_Cart_Coupon_Count_Result.h
 *
 * 
 */

#ifndef OAIResponse_Cart_Coupon_Count_Result_H
#define OAIResponse_Cart_Coupon_Count_Result_H
...
class OAIResponse_Cart_Coupon_Count_Result : public OAIObject {
public:
    OAIResponse_Cart_Coupon_Count_Result();
    OAIResponse_Cart_Coupon_Count_Result(QString json);
    ~OAIResponse_Cart_Coupon_Count_Result() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIResponse_Cart_Coupon_Count_Result)

#endif // OAIResponse_Cart_Coupon_Count_Result_H
