...
bool OAIProduct_Option_Item::isIsDefault() const {
    return m_is_default;
}
void OAIProduct_Option_Item::setIsDefault(const bool &is_default) {
    m_is_default = is_default;
    m_is_default_isSet = true;
}

bool OAIProduct_Option_Item::is_is_default_Set() const{
    return m_is_default_isSet;
}

bool OAIProduct_Option_Item::is_is_default_Valid() const{
