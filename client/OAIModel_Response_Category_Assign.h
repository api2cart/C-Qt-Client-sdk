...
/*
 * OAIModel_Response_Category_Assign.h
 *
 * 
 */

#ifndef OAIModel_Response_Category_Assign_H
#define OAIModel_Response_Category_Assign_H
...
namespace OpenAPI {
class OAIResponse_Category_Assign_Result;

class OAIModel_Response_Category_Assign : public OAIObject {
public:
    OAIModel_Response_Category_Assign();
    OAIModel_Response_Category_Assign(QString json);
    ~OAIModel_Response_Category_Assign() override;
    ...
    OAIResponse_Category_Assign_Result getResult() const;
    void setResult(const OAIResponse_Category_Assign_Result &result);
...
private:
    ...
    OAIResponse_Category_Assign_Result m_result;
    bool m_result_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIModel_Response_Category_Assign)

#endif // OAIModel_Response_Category_Assign_H
