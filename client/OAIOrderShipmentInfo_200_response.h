...
#ifndef OAIOrderShipmentInfo_200_response_H
#define OAIOrderShipmentInfo_200_response_H
...
class OAIOrderShipmentInfo_200_response : public OAIObject {
public:
    OAIOrderShipmentInfo_200_response();
    OAIOrderShipmentInfo_200_response(QString json);
    ~OAIOrderShipmentInfo_200_response() override;
    ...
    OAIShipment getResult() const;
    void setResult(const OAIShipment &result);
...
Q_DECLARE_METATYPE(OpenAPI::OAIOrderShipmentInfo_200_response)

#endif // OAIOrderShipmentInfo_200_response_H
