...
#ifndef OAIModel_Response_Batch_Job_List_H
#define OAIModel_Response_Batch_Job_List_H
...
namespace OpenAPI {
class OAIPagination;
class OAIResponse_Batch_Job_List_Result;

class OAIModel_Response_Batch_Job_List : public OAIObject {
public:
    OAIModel_Response_Batch_Job_List();
    OAIModel_Response_Batch_Job_List(QString json);
    ~OAIModel_Response_Batch_Job_List() override;
    ...
    OAIResponse_Batch_Job_List_Result getResult() const;
    void setResult(const OAIResponse_Batch_Job_List_Result &result);
...
private:
    ...
    OAIResponse_Batch_Job_List_Result m_result;
    bool m_result_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIModel_Response_Batch_Job_List)

#endif // OAIModel_Response_Batch_Job_List_H
