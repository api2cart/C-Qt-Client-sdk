...
#ifndef OAIProductVariantAdd_200_response_H
#define OAIProductVariantAdd_200_response_H
...
namespace OpenAPI {
class OAIProductVariantAdd_200_response_result;

class OAIProductVariantAdd_200_response : public OAIObject {
public:
    OAIProductVariantAdd_200_response();
    OAIProductVariantAdd_200_response(QString json);
    ~OAIProductVariantAdd_200_response() override;
    ...
    OAIProductVariantAdd_200_response_result getResult() const;
    void setResult(const OAIProductVariantAdd_200_response_result &result);
...
private:
    ...
    OAIProductVariantAdd_200_response_result m_result;
    bool m_result_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIProductVariantAdd_200_response)

#endif // OAIProductVariantAdd_200_response_H
