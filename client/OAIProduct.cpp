...
double OAIProduct::getUnitPrice() const {
    return m_unit_price;
}
void OAIProduct::setUnitPrice(const double &unit_price) {
    m_unit_price = unit_price;
    m_unit_price_isSet = true;
}

bool OAIProduct::is_unit_price_Set() const{
    return m_unit_price_isSet;
}

bool OAIProduct::is_unit_price_Valid() const{
    return m_unit_price_isValid;
}

QString OAIProduct::getMeasureUnit() const {
    return m_measure_unit;
}
void OAIProduct::setMeasureUnit(const QString &measure_unit) {
    m_measure_unit = measure_unit;
    m_measure_unit_isSet = true;
}

bool OAIProduct::is_measure_unit_Set() const{
    return m_measure_unit_isSet;
}

bool OAIProduct::is_measure_unit_Valid() const{
...
QString OAIProduct::getUGtin() const {
    return m_u_gtin;
}
void OAIProduct::setUGtin(const QString &u_gtin) {
    m_u_gtin = u_gtin;
    m_u_gtin_isSet = true;
}

bool OAIProduct::is_u_gtin_Set() const{
    return m_u_gtin_isSet;
}

bool OAIProduct::is_u_gtin_Valid() const{
    return m_u_gtin_isValid;
}

QString OAIProduct::getUIsbn() const {
    return m_u_isbn;
}
void OAIProduct::setUIsbn(const QString &u_isbn) {
    m_u_isbn = u_isbn;
    m_u_isbn_isSet = true;
}

bool OAIProduct::is_u_isbn_Set() const{
    return m_u_isbn_isSet;
}

bool OAIProduct::is_u_isbn_Valid() const{
    return m_u_isbn_isValid;
}

QString OAIProduct::getUEan() const {
    return m_u_ean;
}
void OAIProduct::setUEan(const QString &u_ean) {
    m_u_ean = u_ean;
    m_u_ean_isSet = true;
}

bool OAIProduct::is_u_ean_Set() const{
    return m_u_ean_isSet;
}

bool OAIProduct::is_u_ean_Valid() const{
...
QList<QString> OAIProduct::getUpSellProductsIds() const {
    return m_up_sell_products_ids;
}
void OAIProduct::setUpSellProductsIds(const QList<QString> &up_sell_products_ids) {
    m_up_sell_products_ids = up_sell_products_ids;
    m_up_sell_products_ids_isSet = true;
}

bool OAIProduct::is_up_sell_products_ids_Set() const{
    return m_up_sell_products_ids_isSet;
}

bool OAIProduct::is_up_sell_products_ids_Valid() const{
    return m_up_sell_products_ids_isValid;
}

QList<QString> OAIProduct::getCrossSellProductsIds() const {
    return m_cross_sell_products_ids;
}
void OAIProduct::setCrossSellProductsIds(const QList<QString> &cross_sell_products_ids) {
    m_cross_sell_products_ids = cross_sell_products_ids;
    m_cross_sell_products_ids_isSet = true;
}

bool OAIProduct::is_cross_sell_products_ids_Set() const{
    return m_cross_sell_products_ids_isSet;
}

bool OAIProduct::is_cross_sell_products_ids_Valid() const{
