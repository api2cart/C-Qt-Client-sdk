...
#ifndef OAICartGiftcardAdd_200_response_H
#define OAICartGiftcardAdd_200_response_H
...
namespace OpenAPI {
class OAICartGiftcardAdd_200_response_result;

class OAICartGiftcardAdd_200_response : public OAIObject {
public:
    OAICartGiftcardAdd_200_response();
    OAICartGiftcardAdd_200_response(QString json);
    ~OAICartGiftcardAdd_200_response() override;
    ...
    OAICartGiftcardAdd_200_response_result getResult() const;
    void setResult(const OAICartGiftcardAdd_200_response_result &result);
...
private:
    ...
    OAICartGiftcardAdd_200_response_result m_result;
    bool m_result_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAICartGiftcardAdd_200_response)

#endif // OAICartGiftcardAdd_200_response_H
