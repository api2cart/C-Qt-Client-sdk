...
#ifndef OAIProductVariantAddBatch_payload_inner_H
#define OAIProductVariantAddBatch_payload_inner_H
...
namespace OpenAPI {
class OAIProductVariantAddBatch_payload_inner_combination_inner;
class OAIProductUpdateBatch_payload_inner_advanced_prices_inner;
class OAIProductAddBatch_payload_inner_images_inner;

class OAIProductVariantAddBatch_payload_inner : public OAIObject {
public:
    OAIProductVariantAddBatch_payload_inner();
    OAIProductVariantAddBatch_payload_inner(QString json);
    ~OAIProductVariantAddBatch_payload_inner() override;
    ...
    QList<OAIProductVariantAddBatch_payload_inner_combination_inner> getCombination() const;
    void setCombination(const QList<OAIProductVariantAddBatch_payload_inner_combination_inner> &combination);
    ...
    double getMetaTitle() const;
    void setMetaTitle(const double &meta_title);
    bool is_meta_title_Set() const;
    bool is_meta_title_Valid() const;

    double getMetaDescription() const;
    void setMetaDescription(const double &meta_description);
...
private:
    ...
    QList<OAIProductVariantAddBatch_payload_inner_combination_inner> m_combination;
...
Q_DECLARE_METATYPE(OpenAPI::OAIProductVariantAddBatch_payload_inner)

#endif // OAIProductVariantAddBatch_payload_inner_H
