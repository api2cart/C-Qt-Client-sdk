...
/*
 * OAIOrderFind_200_response.h
 *
 * 
 */

#ifndef OAIOrderFind_200_response_H
#define OAIOrderFind_200_response_H
...
namespace OpenAPI {
class OAIOrderFind_200_response_result;

class OAIOrderFind_200_response : public OAIObject {
public:
    OAIOrderFind_200_response();
    OAIOrderFind_200_response(QString json);
    ~OAIOrderFind_200_response() override;
    ...
    OAIOrderFind_200_response_result getResult() const;
    void setResult(const OAIOrderFind_200_response_result &result);
...
private:
    ...
    OAIOrderFind_200_response_result m_result;
    bool m_result_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIOrderFind_200_response)

#endif // OAIOrderFind_200_response_H
