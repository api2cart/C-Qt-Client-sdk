    ...
    if(json["required"].isArray()){
        ...
        if(arr.count() > 0) {
            for (const QJsonValue jval : arr) {
                QList<OAIAccountSupportedPlatforms_200_response_result_supported_platforms_inner_params_required_inner_inner> item;
...
QList<QList<OAIAccountSupportedPlatforms_200_response_result_supported_platforms_inner_params_required_inner_inner>> OAIAccountSupportedPlatforms_200_response_result_supported_platforms_inner_params::getRequired() const {
    return m_required;
}
void OAIAccountSupportedPlatforms_200_response_result_supported_platforms_inner_params::setRequired(const QList<QList<OAIAccountSupportedPlatforms_200_response_result_supported_platforms_inner_params_required_inner_inner>> &required) {
    m_required = required;
...
QList<OAIAccountSupportedPlatforms_200_response_result_supported_platforms_inner_params_required_inner_inner> OAIAccountSupportedPlatforms_200_response_result_supported_platforms_inner_params::getAdditional() const {
    return m_additional;
}
void OAIAccountSupportedPlatforms_200_response_result_supported_platforms_inner_params::setAdditional(const QList<OAIAccountSupportedPlatforms_200_response_result_supported_platforms_inner_params_required_inner_inner> &additional) {
