...
public:
    ...
    QList<OAICustomer_Consent> getConsents() const;
    void setConsents(const QList<OAICustomer_Consent> &consents);
...
private:
    ...
    QList<OAICustomer_Consent> m_consents;
