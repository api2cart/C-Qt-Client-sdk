...
/*
 * OAIOrder_Calculate_Tax.h
 *
 * 
 */

#ifndef OAIOrder_Calculate_Tax_H
#define OAIOrder_Calculate_Tax_H
...
class OAIOrder_Calculate_Tax : public OAIObject {
public:
    OAIOrder_Calculate_Tax();
    OAIOrder_Calculate_Tax(QString json);
    ~OAIOrder_Calculate_Tax() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIOrder_Calculate_Tax)

#endif // OAIOrder_Calculate_Tax_H
