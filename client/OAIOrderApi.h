...
#include "OAIOrderReturnAdd_200_response.h"
...
public:
    ...
    * @param[in]  rounding_precision qint32 [optional]
    * @param[in]  response_fields QString [optional]
    * @param[in]  params QString [optional]
    * @param[in]  exclude QString [optional]
    */
    virtual void orderAbandonedList(const ::OpenAPI::OptionalParam<qint32> &start = ::OpenAPI::OptionalParam<qint32>(), const ::OpenAPI::OptionalParam<qint32> &count = ::OpenAPI::OptionalParam<qint32>(), const ::OpenAPI::OptionalParam<QString> &page_cursor = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &customer_id = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &customer_email = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &store_id = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &created_from = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &created_to = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &modified_from = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &modified_to = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<bool> &skip_empty_email = ::OpenAPI::OptionalParam<bool>(), const ::OpenAPI::OptionalParam<qint32> &rounding_precision = ::OpenAPI::OptionalParam<qint32>(), const ::OpenAPI::OptionalParam<QString> &response_fields = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &params = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &exclude = ::OpenAPI::OptionalParam<QString>());
    ...
    */
    ...
    /**
    * @param[in]  oai_order_return_add OAIOrderReturnAdd [required]
    */
    virtual void orderReturnAdd(const OAIOrderReturnAdd &oai_order_return_add);
    ...
    * @param[in]  store_id QString [optional]
    */
    virtual void orderReturnDelete(const QString &return_id, const QString &order_id, const ::OpenAPI::OptionalParam<QString> &store_id = ::OpenAPI::OptionalParam<QString>());

    /**
    * @param[in]  oai_order_return_update OAIOrderReturnUpdate [required]
    */
    virtual void orderReturnUpdate(const OAIOrderReturnUpdate &oai_order_return_update);
    ...
    */
    ...
    /**
    * @param[in]  oai_order_shipment_add_batch OAIOrderShipmentAddBatch [required]
    */
    virtual void orderShipmentAddBatch(const OAIOrderShipmentAddBatch &oai_order_shipment_add_batch);
    ...
    * @param[in]  response_fields QString [optional]
    */
    virtual void orderStatusList(const ::OpenAPI::OptionalParam<QString> &store_id = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &action = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<bool> &allow_user_defined_order_statuses = ::OpenAPI::OptionalParam<bool>(), const ::OpenAPI::OptionalParam<QString> &response_fields = ::OpenAPI::OptionalParam<QString>());
    ...
    */
    virtual void orderUpdate(const QString &order_id, const ::OpenAPI::OptionalParam<QString> &store_id = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &order_status = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &financial_status = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &fulfillment_status = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &cancellation_reason = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &order_payment_method = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &comment = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &admin_comment = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &admin_private_comment = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &invoice_admin_comment = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &date_modified = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &date_finished = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<bool> &send_notifications = ::OpenAPI::OptionalParam<bool>(), const ::OpenAPI::OptionalParam<bool> &create_invoice = ::OpenAPI::OptionalParam<bool>(), const ::OpenAPI::OptionalParam<QString> &origin = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &tags = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &idempotency_key = ::OpenAPI::OptionalParam<QString>());
...
private:
    ...
    void orderReturnAddCallback(OAIHttpRequestWorker *worker);
    void orderReturnDeleteCallback(OAIHttpRequestWorker *worker);
    void orderReturnUpdateCallback(OAIHttpRequestWorker *worker);
...
Q_SIGNALS:
    ...
    void orderReturnAddSignal(OAIOrderReturnAdd_200_response summary);
    void orderReturnDeleteSignal(OAIAttributeValueDelete_200_response summary);
    void orderReturnUpdateSignal(OAIAccountConfigUpdate_200_response summary);
    ...
    void orderStatusListSignal(OAIModel_Response_Order_Status_List summary);
    ...
    void orderReturnAddSignalFull(OAIHttpRequestWorker *worker, OAIOrderReturnAdd_200_response summary);
    void orderReturnDeleteSignalFull(OAIHttpRequestWorker *worker, OAIAttributeValueDelete_200_response summary);
    void orderReturnUpdateSignalFull(OAIHttpRequestWorker *worker, OAIAccountConfigUpdate_200_response summary);
    ...
    void orderStatusListSignalFull(OAIHttpRequestWorker *worker, OAIModel_Response_Order_Status_List summary);
    ...
    Q_DECL_DEPRECATED_X("Use orderReturnAddSignalError() instead")
    void orderReturnAddSignalE(OAIOrderReturnAdd_200_response summary, QNetworkReply::NetworkError error_type, QString error_str);
    void orderReturnAddSignalError(OAIOrderReturnAdd_200_response summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use orderReturnDeleteSignalError() instead")
    void orderReturnDeleteSignalE(OAIAttributeValueDelete_200_response summary, QNetworkReply::NetworkError error_type, QString error_str);
    void orderReturnDeleteSignalError(OAIAttributeValueDelete_200_response summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use orderReturnUpdateSignalError() instead")
    void orderReturnUpdateSignalE(OAIAccountConfigUpdate_200_response summary, QNetworkReply::NetworkError error_type, QString error_str);
    void orderReturnUpdateSignalError(OAIAccountConfigUpdate_200_response summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use orderShipmentAddBatchSignalError() instead")
    void orderShipmentAddBatchSignalE(OAICategoryAddBatch_200_response summary, QNetworkReply::NetworkError error_type, QString error_str);
    void orderShipmentAddBatchSignalError(OAICategoryAddBatch_200_response summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    void orderStatusListSignalE(OAIModel_Response_Order_Status_List summary, QNetworkReply::NetworkError error_type, QString error_str);
    void orderStatusListSignalError(OAIModel_Response_Order_Status_List summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use orderReturnAddSignalErrorFull() instead")
    void orderReturnAddSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void orderReturnAddSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use orderReturnDeleteSignalErrorFull() instead")
    void orderReturnDeleteSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void orderReturnDeleteSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use orderReturnUpdateSignalErrorFull() instead")
    void orderReturnUpdateSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void orderReturnUpdateSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use orderShipmentAddBatchSignalErrorFull() instead")
    void orderShipmentAddBatchSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void orderShipmentAddBatchSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
