...
#ifndef OAIOrderReturnAdd_H
#define OAIOrderReturnAdd_H
...
namespace OpenAPI {
class OAIOrderReturnAdd_order_products_inner;

class OAIOrderReturnAdd : public OAIObject {
public:
    OAIOrderReturnAdd();
    OAIOrderReturnAdd(QString json);
    ~OAIOrderReturnAdd() override;
    ...
    QList<OAIOrderReturnAdd_order_products_inner> getOrderProducts() const;
    void setOrderProducts(const QList<OAIOrderReturnAdd_order_products_inner> &order_products);
...
private:
    ...
    QList<OAIOrderReturnAdd_order_products_inner> m_order_products;
...
Q_DECLARE_METATYPE(OpenAPI::OAIOrderReturnAdd)

#endif // OAIOrderReturnAdd_H
