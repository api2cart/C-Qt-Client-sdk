...
/*
 * OAIModel_Response_Category_Find.h
 *
 * 
 */

#ifndef OAIModel_Response_Category_Find_H
#define OAIModel_Response_Category_Find_H
...
namespace OpenAPI {
class OAIResponse_Category_Find_Result;

class OAIModel_Response_Category_Find : public OAIObject {
public:
    OAIModel_Response_Category_Find();
    OAIModel_Response_Category_Find(QString json);
    ~OAIModel_Response_Category_Find() override;
    ...
    OAIResponse_Category_Find_Result getResult() const;
    void setResult(const OAIResponse_Category_Find_Result &result);
...
private:
    ...
    OAIResponse_Category_Find_Result m_result;
    bool m_result_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIModel_Response_Category_Find)

#endif // OAIModel_Response_Category_Find_H
