...
/*
 * OAIResponse_Product_Find_Result.h
 *
 * 
 */

#ifndef OAIResponse_Product_Find_Result_H
#define OAIResponse_Product_Find_Result_H
...
class OAIResponse_Product_Find_Result : public OAIObject {
public:
    OAIResponse_Product_Find_Result();
    OAIResponse_Product_Find_Result(QString json);
    ~OAIResponse_Product_Find_Result() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIResponse_Product_Find_Result)

#endif // OAIResponse_Product_Find_Result_H
