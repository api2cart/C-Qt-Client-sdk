...
void OAIOrderAdd::fromJsonObject(QJsonObject json) {
    ...
    m_customer_country_isValid = ::OpenAPI::fromJsonValue(m_customer_country, json[QString("customer_country")]);
    m_customer_country_isSet = !json[QString("customer_country")].isNull() && m_customer_country_isValid;
...
QJsonObject OAIOrderAdd::asJsonObject() const {
    ...
    if (m_customer_country_isSet) {
        obj.insert(QString("customer_country"), ::OpenAPI::toJsonValue(m_customer_country));
    }
...
QString OAIOrderAdd::getCustomerCountry() const {
    return m_customer_country;
}
void OAIOrderAdd::setCustomerCountry(const QString &customer_country) {
    m_customer_country = customer_country;
    m_customer_country_isSet = true;
}

bool OAIOrderAdd::is_customer_country_Set() const{
    return m_customer_country_isSet;
}

bool OAIOrderAdd::is_customer_country_Valid() const{
...
QString OAIOrderAdd::getCarrierId() const {
    return m_carrier_id;
}
void OAIOrderAdd::setCarrierId(const QString &carrier_id) {
    m_carrier_id = carrier_id;
    m_carrier_id_isSet = true;
}

bool OAIOrderAdd::is_carrier_id_Set() const{
    return m_carrier_id_isSet;
}

bool OAIOrderAdd::is_carrier_id_Valid() const{
    return m_carrier_id_isValid;
}

QString OAIOrderAdd::getWarehouseId() const {
    return m_warehouse_id;
}
void OAIOrderAdd::setWarehouseId(const QString &warehouse_id) {
    m_warehouse_id = warehouse_id;
    m_warehouse_id_isSet = true;
}

bool OAIOrderAdd::is_warehouse_id_Set() const{
    return m_warehouse_id_isSet;
}

bool OAIOrderAdd::is_warehouse_id_Valid() const{
...
QString OAIOrderAdd::getOrigin() const {
    return m_origin;
}
void OAIOrderAdd::setOrigin(const QString &origin) {
    m_origin = origin;
    m_origin_isSet = true;
}

bool OAIOrderAdd::is_origin_Set() const{
    return m_origin_isSet;
}

bool OAIOrderAdd::is_origin_Valid() const{
...
bool OAIOrderAdd::isValid() const {
    ...
    return m_order_status_isValid && m_customer_email_isValid && m_bill_first_name_isValid && m_bill_last_name_isValid && m_bill_address_1_isValid && m_bill_city_isValid && m_bill_postcode_isValid && m_bill_state_isValid && m_bill_country_isValid && m_order_item_isValid && true;
}
