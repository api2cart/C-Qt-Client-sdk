...
QString OAIProductVariantAddBatch::getIdempotencyKey() const {
    return m_idempotency_key;
}
void OAIProductVariantAddBatch::setIdempotencyKey(const QString &idempotency_key) {
    m_idempotency_key = idempotency_key;
    m_idempotency_key_isSet = true;
}

bool OAIProductVariantAddBatch::is_idempotency_key_Set() const{
    return m_idempotency_key_isSet;
}

bool OAIProductVariantAddBatch::is_idempotency_key_Valid() const{
