...
/*
 * OAIResponse_Category_Find_Result.h
 *
 * 
 */

#ifndef OAIResponse_Category_Find_Result_H
#define OAIResponse_Category_Find_Result_H
...
class OAIResponse_Category_Find_Result : public OAIObject {
public:
    OAIResponse_Category_Find_Result();
    OAIResponse_Category_Find_Result(QString json);
    ~OAIResponse_Category_Find_Result() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIResponse_Category_Find_Result)

#endif // OAIResponse_Category_Find_Result_H
