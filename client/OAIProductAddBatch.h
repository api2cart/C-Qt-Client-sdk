...
#ifndef OAIProductAddBatch_H
#define OAIProductAddBatch_H
...
namespace OpenAPI {
class OAIProductAddBatch_payload_inner;

class OAIProductAddBatch : public OAIObject {
public:
    OAIProductAddBatch();
    OAIProductAddBatch(QString json);
    ~OAIProductAddBatch() override;
    ...
    QList<OAIProductAddBatch_payload_inner> getPayload() const;
    void setPayload(const QList<OAIProductAddBatch_payload_inner> &payload);
...
private:
    ...
    QList<OAIProductAddBatch_payload_inner> m_payload;
...
Q_DECLARE_METATYPE(OpenAPI::OAIProductAddBatch)

#endif // OAIProductAddBatch_H
